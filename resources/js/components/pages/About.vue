    ...
    <div>
        ...
        <main>
            ...
            <section class="mission mycontents-wide" id="mission">
                ...
                <p class="content-text content-text_mission">
                    当社のサービスを使ったお客様が喜んでくれたり、購入してくださったユーザーの悩みが解決したりなど私たちは持っているテクノロジーや技術を用いて未来を刷新していきます。</p>
            </section>
            <section class="container pb-5" id="board-message">
                <h3 class="subcontent-title subcontent-title_company">CEO MESSAGE / 代表メッセージ</h3>
                <div class="row">
                    <div class="col-md-6">
                        <p class="missioncontent-text">
                        ...
                        <p class="missioncontent-text">中長期的な当社のビジネス計画ドキュメント「Why
                ...
                <ul class="member__contents">
                    <li class="member__list">
                        <div class="member__list__hide">
                            ...
                            <p class="member__list__hide__text">
                ...
                <ul class="member__contents mt-4">
                    <li class="member__list member__list">
                        <div class="member__list__hide">
                            ...
                            <p class="member__list__hide__text">パンジャブ州ラホールに生まれる。 彼はPMAS有道農業大学のコンピュータサイエンス学部を卒業しました。
                    ...
                    <li class="member__list member__list">
                        <div class="member__list__hide">
                            ...
                            <p class="member__list__hide__text">ラホール、パンジャブから。 ヴァーチャル大学コンピュータサイエンス学部卒業。
                    ...
                    <li class="member__list member__list">
                        <div class="member__list__hide">
                            <p class="member__list__hide__titile">Backend Lead</p>
                            <p class="member__list__hide__text">パンジャブ州ラホール出身。GCUF大学のコンピューターサイエンス学部を卒業。前職ではANZGlobal
                    ...
                    <table class="company__contents">
                        <tbody class="company__contents__left">
                            ...
                            <tr>
                                ...
                                <td class="company__list__td">B1F 176 Yblock DHA Phase3, Lahore　>><a
                                        href="https://goo.gl/maps/CV364GyvjGyQv3X97" target="_blank">Google Map</a></td>
                            </tr>
                            <tr>
                                <th>
            ...
            <section class="mycontents-wide history-section" id="history">
                ...
                <div class="history-list">
                    <ol>
                        <li><span class="year"><span>2020/01</span></span><span
                                class="year-description">リモートベースでIdenbrid Inc.設立</span></li>
                        <li><span class="year"><span>2020/09</span></span><span class="year-description">本社オフィスをDD Block
                                Phase3に移設</span></li>
                        <li><span class="year"><span>2020/10</span></span><span
                                class="year-description">日本向け受託開発開始</span></li>
                        <li><span class="year"><span>2021/04</span></span><span class="year-description">本社オフィスをY Block
                                Phase3に移転</span></li>
                        <li><span class="year"><span>2021/08</span></span><span class="year-description">社名を「IDENBRID
                                INC.」に変更</span></li>
                        <li><span class="year"><span>2021/11</span></span><span class="year-description">「Online
                                Development Hub」サービス開始</span></li>
                        <li><span class="year"><span>2022/02</span></span><span
                                class="year-description">プログラミンスクール「IdenSpire」開始</span></li>
                        <li><span class="year"><span>2022/04</span></span><span
                                class="year-description">現在、世界12カ国の企業とIT開発取引</span></li>
                    </ol>
                </div>
            </section>
        </main>
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.$nextTick(() => {
                document.getElementById(this.$route.params.string).scrollIntoView({
                    behavior: 'smooth'
                });
            });
