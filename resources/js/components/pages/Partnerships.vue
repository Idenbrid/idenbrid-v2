    ...
    <div>
        ...
        <main>
            ...
            <section class="mission mycontents-wide mt-4" id="overview">
                ...
                <p class="content-text content-text_mission">Online Development
                    Hubとは世界のITサービスを構築する工場なハブとなる拠点を指して<br>います。当社ではパキスタンに自社エンジニアを抱え日本を初め世界中の企業様と日々取引<br>を行っています。<br>このサービスの特徴はお客様ご自身でIT知識やエンジニアを抱える必要がなく、ITサービス<br>の展開ができたり自社のサイトやアプリの運用が可能です。そして正社員を抱える必要もな<br>いので貴社のビジネスリスクの軽減になります。<br>当社では上手く日本人エンジニアとハブ拠点の人材とで分業することで質の高いサービスを<br>提供し続けています。
                </p>
            </section>
            ...
            <div class="mycontents-wide" id="office_environment">
                ...
                <p class="content-text content-text_office">
                    リモートワークが進む現代で、課題に感じているメンタルケアや仲間同士のコミュニケーション課題<br>を解決するため出社したくなるオフィス作りを行っています。</p>
            </div>
            ...
            <section class="system-sec mycontents-wide" id="client_benifits">
                ...
                <p class="system-sec__text">
                    私たちは日本国内や他国のオフショア拠点よりも人件費がよりリーズナブルな価格で世界のIT開発拠点となるHubを自社で構築しています。<br>これを使って今後とも様々な企業とお仕事をするとともに、世界のIT開発を牽引するテックリードカンパニーになる足掛かりとしていきます。
                </p>
