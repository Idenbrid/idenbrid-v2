...
<main>
    <div class="main-contents mycontents-wide">
        <section class="single">
            ...
            <img class="single__thumbnail" :src="'https://admin-idenbrid.idenbrid.com/public/storage/blog_images/'+blog.image" alt="" loading="lazy"/>
        ...
        <aside class="aside">
            <div class="aside__new">
                <p class="aside__title aside__title__new"><img src="/public/assets/img/icons/single-aside-new.png" alt="" loading="lazy"> 関連ブログ記事</p>
                ...
                <ul class="aside__new__contents">
                    <li v-for="latest in latest_blogs" :key="latest.id" class="aside__new__list">
                        <router-link :to="'/blog/detail/'+latest.id">
                            <img class="aside__new__list__thumbnail" :src="'https://admin-idenbrid.idenbrid.com/public/storage/blog_images/'+latest.image" alt="" loading="lazy">
    ...
    <section class="btns">
        <a @click="prev(blog.id)" v-if="previous == true" to="" rel="prev">
            <img class="btns__prev__img" src="/public/assets/img/icons/single-prev.svg" alt="前のニュースへ" width="7"/>
        ...
        <a @click="latests(blog.id)" v-if="latest == true" rel="next">
            <img class="btns__prev__img btns__next__img" src="/public/assets/img/icons/single-prev.svg" alt="前のニュースへ" width="7"/>
            <p class="btns__prev__text">前の記事へ</p>
        </a>
    </section>
     <section class="menu">
