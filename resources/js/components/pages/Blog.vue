    ...
    <main>
      <div class="mv_textarea">
        <h2>
          ...
          <span class="jptxt"
            >このブログでは業務システム、ウェブやスマホアプリを開発する際に役立つ情報を発信しています。</span
          >
        </h2>
      </div>
      <section class="blog">
        ...
        <div class="blog--content--inner">
              ...
              >
                ...
                <div class="writing fade_y on">
                  <div class="good">
                    ...
                    <i
                      v-if="blog.is_liked == false"
                      @click.prevent="likeBlog(blog.id)"
          ...
          <div class="blog--content--sidearea">
            ...
            <div class="sp_cat">
              <a
                href="https://tomorrowgate.co.jp/blog/"
                class="categoryitem current fade_y on"
                >全てのカテゴリー</a
              >
              <a
                href="https://tomorrowgate.co.jp/blog_category/pickup/"
                class="categoryitem fade_y pickup on"
                >おすすめ（3）</a
              >
            </div>
...
export default {
  ...
  metaInfo() {
    return {
      title:
        "お知らせ・ブログ | システム開発はアイデンブリッド社 | IDENBRID INC.",
      meta: [
        {
          vmid: "description",
          ...
          content:
            "アイデンブリッドではお知らせやブログを定期的に更新しており、皆様が日々抱くサイト構築やアプリ開発の疑問やサイトをローンチした後の運用に関しての疑問に答えるブログ記事を公開しています。",
        },
      ],
    };
  },
  ...
  methods: {
    ...
    async likeBlog(id) {
      try {
        const { data } = await axios.post("/api/like-blog/" + id);
