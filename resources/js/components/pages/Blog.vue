    ...
    <main>
              ...
              <div v-for="blog in blogs" :key="blog.id" class="blog--content--item">
                <router-link :to="'/blog/detail/' + blog.id + '/'" class="hoverScale fade_y on">
                  ...
                  <div class="bloginfo">
                    ...
                    <span class="cat workstyle">BLOG</span>
                  </div>
                ...
                <div class="writing fade_y on">
                  <div class="good">
                    ...
                    <i v-if="blog.is_liked == false" @click.prevent="likeBlog(blog.id)" class="fa-regular fa-heart">like</i>
                    <i v-else @click.prevent="likeBlog(blog.id)" class="fa-solid fa-heart">unlike</i>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="blog--content--sidearea">
            <div class="searcharea fade_y on">
              <form @submit.prevent="handleSearch">
                ...
                <input v-model="search_word" name="s" type="text" class="search-text" placeholder="キーワード検索" />
                ...
                <div class="thumb photo thumb-img">
                  ...
                  <div class="scaleImg scale-img">
                    <img width="1200" height="630" :src="
                        'https://admin-idenbrid.idenbrid.jp/public/storage/blog_images/' +
                        item.image
                      " class="attachment-full size-full wp-post-image" alt="" loading="lazy" sizes="(max-width: 1200px) 100vw, 1200px" />
                  </div>
                </div>
                <div class="bloginfo">
            ...
            <div class="recommend--list popular pc">
              <a href="https://tomorrowgate.co.jp/blog/1673/" class="hoverScale recommend--item popular">
                <div class="thumb photo thumb-img">
                  ...
                  <div class="scaleImg scale-img">
                    <img width="1200" height="630" src="https://tomorrowgate.co.jp/wp-content/uploads/2021/08/210826_REALBRANDING.jpg" class="attachment-full size-full wp-post-image" alt="" loading="lazy" srcset="
                        https://tomorrowgate.co.jp/wp-content/uploads/2021/08/210826_REALBRANDING.jpg          1200w,
                        https://tomorrowgate.co.jp/wp-content/uploads/2021/08/210826_REALBRANDING-300x158.jpg   300w,
                        https://tomorrowgate.co.jp/wp-content/uploads/2021/08/210826_REALBRANDING-1024x538.jpg 1024w,
                        https://tomorrowgate.co.jp/wp-content/uploads/2021/08/210826_REALBRANDING-768x403.jpg   768w
                ...
                <div class="bloginfo">
                  ...
                  <div class="good">
                    <i class="fa fa-heart mr-1" aria-hidden="true"></i>62
                  </div>
                </div>
                <h3 class="hvrunder">
              ...
              <a href="https://tomorrowgate.co.jp/blog/2954/" class="hoverScale recommend--item popular">
                <div class="thumb photo thumb-img">
                  ...
                  <div class="scaleImg scale-img">
                    <img width="1200" height="630" src="https://tomorrowgate.co.jp/wp-content/uploads/2021/10/blog_thumb-1.jpg" class="attachment-full size-full wp-post-image" alt="" loading="lazy" srcset="
      ...
      <div class="branding--contact" bis_skin_checked="1">
        ...
        <div class="fade_y on" bis_skin_checked="1">
          <a href="https://tomorrowgate.co.jp/contact/" class="contactbtn fade_y on" bis_skin_checked="1">今すぐ相談してみる</a>
        </div>
      </div>
    </main>
    <Footer />
