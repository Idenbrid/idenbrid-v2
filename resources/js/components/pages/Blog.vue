                                ...
                                <div class="writing fade_y on">
                                    <div class="good">
                                        ...
                                        <i v-if="blog.is_liked == false" @click.prevent="likeBlog(blog.id)"
                                            class="fa fa-heart like-icon"> <span></span></i>
                                        <i v-else @click.prevent="likeBlog(blog.id)"
                                            class="fa fa-heart-o like-icon"> <span></span> </i>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="blog--content--sidearea">
                        <div class="searcharea fade_y on">
                            <form @submit.prevent="handleSearch">
                                ...
                                <input v-model="search_word" name="s" type="text" class="search-text"
                                    placeholder="キーワード検索" />
                        ...
                        <div class="recommend--list popular pc">
                            <router-link :to="'/blog/detail/' + blog.id + '/'" v-for="blog in most_liked" :key="blog.id"
                                ...
                                <div class="bloginfo">
                                    <time class="time en">{{blog.date}}</time>
                                    <div class="good">
                                        <i class="fa fa-heart mr-1" aria-hidden="true"></i>{{blog.count}}
                                    </div>
                                </div>
                                <h3 class="hvrunder">
                                    {{blog.title}}
