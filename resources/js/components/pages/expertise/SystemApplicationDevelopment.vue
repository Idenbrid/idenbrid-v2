                ...
                <ul class="system-sec__contents ">
                    ...
                    <!-- <li class="system-sec__list">
                        <img class="system-sec__list__thumbnail"
                            ...
                            alt="">
                        <h3 class="system-sec__list__title">アンケート管理システム</h3>
                        <p class="system-sec__list__text">
                            顧客アンケートや既存ユーザーの満足度アンケートなどを自動で管理できるシステムを提供致します。複数のテンプレやフォームを用意し、使い勝手の良いシステムを構築致します。</p>
                    </li>
                    <li class="system-sec__list">
                        <img class="system-sec__list__thumbnail"
                            src="https://whitecanvas.jp/wp-content/themes/whitecanvas_fix_thema-main/img/icon/system/db05.svg"
                            alt="">
                        <h3 class="system-sec__list__title">顧客管理システム</h3>
                        <p class="system-sec__list__text">
                            ECサイトと連携した顧客管理システムを導入することで販売データの分析や顧客分析が可能となるシステムを開発します。<br>分析したいデータに合わせて使い勝手の良いシステムを構築致します。
                        </p>
                    </li>
                    <li class="system-sec__list">
                        <img class="system-sec__list__thumbnail"
