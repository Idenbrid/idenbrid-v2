<template>
    <div>
        ...
        <main>
            <div class="profile--index highlight_blk">
               <div class="row">
                <div class="col-md-7">
                <div class="prof_tbl">
                    <dl>
            ...
            <div class="col-md-5">
                <video width="100%" autoplay="autoplay" loop="loop" muted="muted"><source  src="/assets/videos/company-intro.mp4" type="video/mp4"></video>
            </div>
            </div>
            </div>
